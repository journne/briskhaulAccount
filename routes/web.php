...
Route::resource('delivery-modes','DeliveryModeController');
Route::resource('pharmacies','PharmacyController');
Route::resource('pharmacy-items','PharmacyItemController');
Route::resource('in-app-messages','InAppMessageController');
Route::resource('terms-and-conditions','TermsAndConditionController');
Route::resource('promotional-ads','PromotionalAdController');
